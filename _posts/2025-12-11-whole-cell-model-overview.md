...
description: breof overview of current states of whole-cell modeling/virtual cell
tags: wcm
...
PI: Leslie Loew While "AI Virtual Cell" is a project name, VCell is the actual software platform used by thousands of biologists since the late 90s.
...
PI: Eran Agmon (University of Connecticut) As models get complex, you need "glue" to stick them together. Vivarium is a Python-based interface that allows a metabolic model written in one language to talk to a signaling model written in another. It is the operating system for the mechanistic whole-cell models of the future.
