...
Because you are describing _what_ you want to do (add these tiles) rather than _how_ to do it (thread instruction stream), your Python code becomes portable. Code written for a Blackwell GPU today is designed to work on future NVIDIA architectures without a rewrite.
